        ...
        <ul class="sidebar-links">
          ...
          <li class="mobile-dropdown">
            ...
            <ul class="mobile-dropdown-menu" v-show="showMobileResourcesDropdown">
              <li><router-link to="/training-tips"><i class="fas fa-paw"></i>Training Tips</router-link></li>
              <li><router-link to="/success-stories"><i class="fas fa-dog"></i>Success Stories</router-link></li>
            </ul>
          </li>
